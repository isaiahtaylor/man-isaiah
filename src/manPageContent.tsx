...
const elements = [
  ...
  <IL></IL>,
  <IL>In late 2019, I started <a href="https://hoodhub.com">HoodHub</a>, an IoT connected car platformed aimed at</IL>,
  <IL>syncronizing auto shops with their customers. We had a lot of fun</IL>,
  ...
  <IL>That startup failed for a number of reasons which needs to be written about at</IL>,
  <IL>length. When I get around to it, I'll put a link here.</IL>,
  <IL></IL>,
  <IL>Since HoodHub wrapped up, I have turned my attention to consulting for a while,</IL>,
  <IL>espcially in the area of designing and building cloud applications. I've been doing</IL>,
  <IL>that for around 2 years now. First, for Splunk, then briefly General Dynamics, and</IL>,
  <IL>most recently under NDA for a hedge fund.</IL>,
  <Line />,
